...
public class MainActivity extends AppCompatActivity {
    ...
    String url = "https://www.jsonkeeper.com/b/CXRP";
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++) {
                    ...
                    try {
                        ...
                        String courseName = responseObj.getString("food");
                        String courseTracks = responseObj.getString("rating");
                        String courseMode = responseObj.getString("review");
                        String courseImageURL = responseObj.getString("foodImg");
